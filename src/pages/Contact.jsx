          ...
          <div className="card shadow-sm">
            <div className="card-body">
              ...
              <p className="card-text mb-4">
                If you want to reach out, you can use any of the options below. I&apos;m happy to hear from you about games, feedback, or just to say hello.
              </p>
                ...
                <div className="col-md-6">
                  <div className="card border-light bg-light h-100">
                    <div className="card-body">
                      ...
                      <p className="card-text">
                        <a href="mailto:hello@example.com" className="text-decoration-none">
                          hello@example.com
                        </a>
                      </p>
                    </div>
              ...
              <div className="mt-4">
                <h5>Social Media</h5>
                <p className="mb-2">Connect with me through any of these profiles:</p>
